...
import {ReactComponent as ShoppingCart} from
'./assets/winkelmandje.svg'
...
function App() {
    return (
        ...
        <main>
            ...
            Van citroen kun je het vruchtvlees, het sap en de schil gebruiken. Het sappige,
        ...
        <Product
             ...
             description=" Limoen is familie van de citroen en de sinaasappel en behoort tot de
                 citrusvruchten (Wijnruitfamilie).
